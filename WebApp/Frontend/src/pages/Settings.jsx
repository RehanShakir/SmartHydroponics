...
const Settings = () => {
  ...
  useEffect(() => {
    setMacaddressess(macAddressess?.data?.Macaddressess);
  }, [macAddressess?.data?.Macaddressess]);
    ...
    <>
      ...
      pt-2'>
          ...
          <button
            ...
            style={{ cursor: "none" }}>
            {macAddressess?.data?.Macaddressess?.userId?.fullName}
          </button>
          {/* </Link> */}
        </div>
          ...
          <div className='table-responsive pl-0 pr-0'>
            <table className='table  background_table'>
              ...
              {macaddressess && Object.keys(macaddressess).length > 0 && (
                <tbody>
                  {macaddressess?.macAddress?.map(userDataArea) || <Empty />}
                </tbody>
              )}
            </table>
